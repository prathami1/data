    ...
    [19], {
        ...
        IKlv: function(e, t, r) {
            ...
            var n = r("vJKn"),
                ...
                f = r("7KCV"),
                p = r("AroE");
            t.__esModule = !0, t.render = W, t.renderError = $, t.default = t.emitter = t.router = t.version = void 0;
            var l = p(r("1ccW")),
                d = (p(r("7KCV")), p(r("zx1J"))),
                m = p(r("o7G4")),
                h = p(r("DqTX")),
            ...
            var K = function(e) {
                    ...
                    return c(t, e), o(t, [{
                        ...
                        value: function() {
                            this.scrollToHash(), H.isSsr && (D || C.nextExport && ((0, P.isDynamicRoute)(H.pathname) || location.search) || S.__N_SSG && location.search) && H.replace(H.pathname + "?" + (0, x.stringify)((0, l.default)({}, H.query, {}, (0, x.parse)(location.search.substr(1)))), O, {
                                _h: 1,
                                shallow: !D
                            })
                        }
                ...
                return n.async((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 7:
                            ...
                            break;
                        case 9:
                            return t.prev = 9, t.t0 = t.catch(4), t.next = 13, n.awrap($((0, l.default)({}, e, {
                                err: t.t0
                            })));
                        case 13:
                        case "end":
                ...
                return n.async((function(c) {
                    for (;;) switch (c.prev = c.next) {
                        case 0:
                            ...
                            break;
                        case 3:
                            return console.error(r), c.next = 7, n.awrap(B.loadPage("/_error"));
                        case 7:
            ...
            t.default = function(e) {
                ...
                return n.async((function(c) {
                    for (;;) switch (c.prev = c.next) {
                        case 0:
                            return (void 0 === e ? {} : e).webpackHMR, c.next = 4, n.awrap(B.loadPageScript("/_app"));
                        case 4:
                            return r = c.sent, a = r.page, o = r.mod, X = a, o && o.unstable_onPerformanceData && (Y = function(e) {
                                var t = e.name,
                                    r = e.startTime,
                                    n = e.value,
                                    a = e.duration,
                            ...
                            }), i = T, c.prev = 10, c.next = 14, n.awrap(B.loadPage(k));
                        case 14:
                            s = c.sent, F = s.page, c.next = 20;
                            break;
                        case 20:
                            c.next = 25;
                            break;
                        ...
                        case 28:
                            return t.router = H = (0, v.createRouter)(k, N, O, {
                                initialProps: S,
                                pageLoader: B,
                                App: X,
                                Component: F,
            ...
            function ne(e) {
                var t = e.children;
                return d.default.createElement(K, {
                    fn: function(e) {
                        return $({
                            App: X,
                            err: e
            ...
            function oe(e) {
                ...
                return n.async((function(h) {
                    for (;;) switch (h.prev = h.next) {
                        case 0:
                            if (t = e.App, r = e.Component, a = e.props, o = e.err, a || !r || r === U || G.Component !== U) {
                                h.next = 8;
                                break
                            }
                            return s = (i = H).pathname, c = i.query, u = i.asPath, f = ae(t), p = {
                                router: H,
                                AppTree: f,
                                Component: U,
                                ctx: {
                        ...
                        case 7:
                            a = h.sent;
                        case 8:
                            r = r || G.Component, a = a || G.props, m = (0, l.default)({}, a, {
                                Component: r,
                                err: o,
                                router: H
                            }), G = m, Z.emit("before-reactdom-render", {
                                Component: r,
                                ErrorComponent: U,
                                appProps: m
                            }), Q(d.default.createElement(ne, null, d.default.createElement(t, m)), J), Z.emit("after-reactdom-render", {
                                Component: r,
                                ErrorComponent: U,
                                appProps: m
                            });
